...
export class DatabaseService
{
    ...
    create(data: any): Observable<any> {
        return this._httpClient
          .post(environment.baseurl + '/api/influencer', data, this.httpOptionsFormdata)
          .pipe(
      ...
      update(data: any,id: any): Observable<any> {
        ...
        return this._httpClient
            .put(
                environment.baseurl + '/api/influencer/'+ id,
                data,
    ...
    getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
      ...
      updateIron(data: any): Observable<any> {
        return this._httpClient
            .post(
                environment.baseurl + '/api/influencer/',
                data,
            )
            .pipe(
                switchMap((response: any) => {
    ...
    getById(id: any): Observable<any[]> {
        return this._httpClient
            .get<any[]>(environment.baseurl + '/api/influencer/' + id)
            .pipe(
                tap((meterial) => {
    ...
    getFloor(s_id:any): Observable<any> {
        return this._httpClient
            .get<any>(environment.baseurl + '/api/get_floor/' + s_id)
            .pipe(
                tap((meterial) => {
                    this._materials.next(meterial);
                })
    ...
    getChanel(s_id : any, f_id : any): Observable<any> {
        return this._httpClient
            .get<any>(environment.baseurl + '/api/get_channel/' + s_id + '/' + f_id )
            .pipe(
                tap((meterial) => {
                    this._materials.next(meterial);
                })
    ...
    getCategory(): Observable<any> {
        return this._httpClient
            .get<any>(environment.baseurl + '/api/influencer_page')
            .pipe(
                tap((data) => {
